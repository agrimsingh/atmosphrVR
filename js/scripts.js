...
if(isMobile.any()){
    	$(".vr_main").delay(2000).fadeIn("slow");
} else {
   $(window).load(function() {

	$("#big-video-wrap").delay(500).fadeIn("slow");
	$(".vr_main").delay(1000).fadeIn("slow");
...
preload([
    ...
    'images/customizable.jpg',
    'images/interior.jpg',
    // 'images/contact.jpg',
    'images/img-advertiser.jpg',
    'images/atm.jpg',
    'images/expandable.jpg',
    'images/event.jpg',
    'images/seamless.jpg',
    'images/user.jpg',
...
$(document).ready(function(){
	...
	$('.vr_main').css('margin-top', ($(window).height()-45)+"px");
...
//Sticky Navigation
    $("#navigation").sticky({topSpacing:"0px",
'offset' : "100px"});

   $('.vr_section').height($(window).height()+50);
...
//Navigation Scrolling
	$(function() {
		$('.nav a, .nav li a, #home-center a, a.move, .down, .request').bind('click',function(event){
		var $anchor = $(this);
...
//
// var map = new L.mapbox.map('farm', 'garudarobotics.ind9i40p',
// 		{
// 			center: new L.LatLng(1.388679, 103.729899),
// 			zoom: 18}
// 		);
...
/*function init(){
    ...
    var p1 = new L.LatLng(1.38942, 103.72932),
        p2 = new L.LatLng(1.38926, 103.73045),
        p3 = new L.LatLng(1.38767, 103.73023),
        p4 = new L.LatLng(1.38783, 103.72910),
    ...
    var bounds = new L.LatLngBounds(
            new L.LatLng(1.387621, 103.729092),
            new L.LatLng(1.389424, 103.730489));
    var options = {
            minZoom: 17,
            maxZoom: 22,
            opacity: 1.0,
...
function activateGarudaMaps(){
    	$('.leaflet-google-layer').fadeTo( "slow" , 0.5, function() {
    // Animation complete.
  });
    }
...
$('#shortcuts li').click(function(){
	...
	$(this).addClass('active');
	console.log('#000000 url("../images/'+$(this).find('div').attr('id')+'.jpg"');
	var divName = $(this).find('div').attr('id');
	$('#applications').css('background','#000000 url("images/'+divName+'.jpg") no-repeat 49.9% center');
  $('#applications').css('background-size','cover');
  $('#applications').css('width','100%');
	$('.app_info').hide();
	$('#'+divName+'_').show();
});


$('#sensor_shortcuts li').click(function(){

	$('#sensor_shortcuts li').removeClass('active');
	$(this).addClass('active');
	console.log('#000000 url("../images/'+$(this).find('div').attr('id')+'.jpg"');
	var divName = $(this).find('div').attr('id');
	$('#features').css('background','#000000 url("images/'+divName+'.jpg") no-repeat 49.9% center');
  $('#features').css('background-size','cover');
